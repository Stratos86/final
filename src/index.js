...
var base = Rebase.createClass({
  apiKey: "AIzaSyBWYKKkRfiZWlIMfTWnX8YyC0xb682_Qdg",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-final-5274d.firebaseio.com/", // replace with your Firebase application's database URL
})
          ...
          return (
                  <div className="map col-sm-12">
                    <Gmaps width={'100%'}
                           ...
                           lng={'-87.6285782'}
                           zoom={11}
                           loadingMessage={'Loading theaters near you...'}
